...
class Game:
    def __init__(self):
        ...
        # 보스 스프라이트 세트
        self.spr_enemy['Boss'] = createSpriteSet(self.spriteSheet_boss, 1, 12)
        ...
        # 보스 생성 변수
        obj_snake = createObject(self.spr_enemy['Boss'], (random.randrange(0, 960), 100), 'Boss', self)  # 레벨 구현 미정
    ...
    def run(self):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if (pygame.sprite.collide_rect(self.player_rect, self.Boss_rect)):       # 보스와 플레이어의 히트박스 충돌처리
